...
void SudokuView::display(){
  ...
  strm <<model->Hours_in_game;std::string numStr = "TIME = ";if(strm.str().length()==1)numStr+='0'; numStr += strm.str(); strm.str(std::string());
  strm <<model->Minutes_in_game; numStr = numStr + ":"; if(strm.str().length()==1)numStr+='0'; numStr += strm.str();strm.str(std::string());
  strm <<model->Seconds_in_game; numStr = numStr + ":";if(strm.str().length()==1)numStr+='0'; numStr += strm.str();strm.str(std::string());
